...
/* wheelnav.prototype.updateWeekInfoYDC                                                    */
/* ======================================================================================= */
...
wheelnav.prototype.updateStateInfoYDC = function(message) {
  $("#currentStateInfoYDC").text(message);
}

wheelnav.prototype.updateHourInfoYDC = function(message) {
  $("#currentHourInfoYDC").text(message);
}

wheelnav.prototype.updateWeekInfoYDC = function(message) {
  $("#currentWeekInfoYDC").text(message);
}
    ...
    for (i = 0; i < this.navItemCount; i++) {
        ...
        if (i === clicked) {
            if (this.multiSelect) {
                ...
                var ydcHolderID = navItem.wheelnav.holderId;
                if (ydcHolderID == "divWheelnavDateTime") {
                  this.updateWeekInfoYDC(navItem.title);
                } else if (ydcHolderID == "divWheelnavDateTimeHour") {
                  this.updateHourInfoYDC(navItem.title);
                } else if (ydcHolderID == "divWheelnavDateTimeState") {
                  this.updateStateInfoYDC(navItem.title);
                } else {
                  console.log("Error: "+navItem.wheelnav.holderId);
                }
                /*
                for (var key in navItem.wheelnav) {
                  if (navItem.wheelnav.hasOwnProperty(key)) {
                    console.log(key);
                  }
                }
                */
